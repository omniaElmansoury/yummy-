...
let urlfetch=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchspecificmeal=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchspecificmealr=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchsaerchr=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchsaerchf=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchspecificmealrf=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let urlfetchc=`www.themealdb.com/api/json/v1/1/random.php`;
...
let fetchsaerchfvn=`www.themealdb.com/api/json/v1/1/random.php`;
...
let fetchsaerchfv=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchspecificmealrd=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetcharea=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchaeaedis=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchspecificde=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchinger=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchsmall=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
...
let fetchdetails=`www.themealdb.com/api/json/v1/1/search.php?f=a`;
